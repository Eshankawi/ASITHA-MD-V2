...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=2r5mBZ6C#bylXVwKH1wfLIglf_3H3tH3dML3RTQvJE8nMt-brbHI' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
ALIVE_MSG: process.env.ALIVE_MSG === undefined ? "*Hҽყ Tԋҽɾҽ I`ɱ Ｅꜱʜᴜ ||°* ♥️ 🪄" : process.env.ALIVE_MSG,
